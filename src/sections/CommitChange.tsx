...
export default function CommitChange() {
  ...
  return (
    <section
      ref={sectionRef}
      className="section-pinned bg-gym-black z-50"
      style={{ height: '100vh' }}
    >
      {/* Background Image */}
      <div ref={bgRef} className="absolute inset-0">
        <img
          src="/images/scene_commit_bg.jpg"
          alt="Cardio training"
      ...
      >
        <img
          src="/images/scene_commit_cut.jpg"
          alt="Athlete committed to change"
          className="w-full h-full object-cover"
        />
      </div>
      ...
      >
        <h2 className="font-display font-black text-4xl sm:text-5xl lg:text-[clamp(34px,4.2vw,64px)] text-white uppercase leading-[1.1] tracking-[-0.02em] mb-6">
          Commit to
          <br />
          <span className="text-gym-orange">Change</span>
        </h2>
        <p className="text-gym-gray text-base lg:text-lg mb-8 leading-relaxed max-w-md">
          Structured conditioning blocks, heart-rate-friendly progressions, and clear metrics so you know you're getting fitter. 
